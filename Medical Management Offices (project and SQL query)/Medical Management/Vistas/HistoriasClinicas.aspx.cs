    ...
    public partial class HistoriasClinicas : System.Web.UI.Page
    {
        ...
        protected void grdHistoriasClinicas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "eventoDetalle")
            {
                ...
                lblMensaje.Text = " " +s_hc_Nombre +" "+s_hc_Apellido+" Medical record selected. Medical record N° " + s_hc_Legajo + ". Patient N° " + s_hc_CodPaciente;
        ...
        protected void grdHistoriasClinicas_SelectedIndexChanged(object sender, EventArgs e)
        {
