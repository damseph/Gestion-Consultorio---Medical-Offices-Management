...
namespace Vistas
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void btnAgregarTurno_Click(object sender, EventArgs e)
        {
            ...
            if (estado == true)
            {
                lblMensajeTur.Text = "Appointment added!!";
                limpiar();
            ...
            {
                lblMensajeTur.Text = "Appointment couldn't be added, some fields are empty";
            }
        }
        ...
        protected void btnApaso2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblValidarDni.Text = "Patient ID doesn't exist. Please enter an existing ID or add patient --->";
        ...
        protected void ddlEspecialidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ddlEspecialistas.Items.Insert(0, new ListItem("--Select--", "0"));
        ...
        {
            lblDatosTurno.Text += "PATIENT ID: " + txtDNIPac.Text + "</br>";
            lblDatosTurno.Text += "PATIENT FULL NAME: " + pac.ObtenerDatosPaciente(txtDNIPac.Text) + "</br>";
            lblDatosTurno.Text += "MEDICAL FIELD: " + ddlEspecialidad.SelectedItem.ToString() + "</br>";
            lblDatosTurno.Text += "DOCTOR: " + ddlEspecialistas.SelectedItem.ToString() + "</br>";
            lblDatosTurno.Text += "DATE: " + lblFecha.Text + "</br>"; 
            lblDatosTurno.Text += "ROOM Nº: " + tur.buscarConsultorio(ddlEspecialidad.SelectedItem.Value) + "</br>";
        }
    }
}